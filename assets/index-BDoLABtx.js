(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`/portfolio/assets/hlegal.png-KLhhl4rg.png`,t=`/portfolio/assets/web-new.png-Gjb4CA1E.png`,n=`/portfolio/assets/hero%201-DyHo86Lz.png`,r=`/portfolio/assets/frontend-certificate-DuOfI1on.png`,i=`/portfolio/assets/prompt-certificate-DYR_fjxZ.png`,a=`data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2024%2024'%20fill='%23ffffff'%3e%3cpath%20d='M12%202C6.48%202%202%206.58%202%2012.25c0%204.54%202.87%208.39%206.84%209.75.5.1.68-.22.68-.49%200-.24-.01-.88-.01-1.73-2.78.62-3.37-1.37-3.37-1.37-.45-1.18-1.11-1.5-1.11-1.5-.91-.64.07-.63.07-.63%201%20.07%201.53%201.05%201.53%201.05.89%201.57%202.34%201.12%202.91.86.09-.67.35-1.12.63-1.38-2.22-.26-4.56-1.14-4.56-5.08%200-1.12.39-2.03%201.03-2.75-.1-.26-.45-1.31.1-2.73%200%200%20.84-.28%202.75%201.05A9.3%209.3%200%200%201%2012%206.84c.85%200%201.7.12%202.5.35%201.9-1.33%202.74-1.05%202.74-1.05.56%201.42.21%202.47.11%202.73.64.72%201.03%201.63%201.03%202.75%200%203.95-2.34%204.81-4.57%205.07.36.32.68.95.68%201.91%200%201.38-.01%202.49-.01%202.83%200%20.27.18.59.69.49A10.26%2010.26%200%200%200%2022%2012.25C22%206.58%2017.52%202%2012%202z'/%3e%3c/svg%3e`,o=`data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2024%2024'%20fill='%230A66C2'%3e%3cpath%20d='M4.98%203.5C4.98%204.88%203.87%206%202.49%206S0%204.88%200%203.5%201.11%201%202.49%201s2.49%201.12%202.49%202.5zM.5%208h4v13h-4V8zm7%200h3.8v1.8h.05c.53-1%201.82-2.05%203.75-2.05%204.01%200%204.75%202.64%204.75%206.08V21h-4v-6.4c0-1.53-.03-3.49-2.13-3.49-2.13%200-2.46%201.66-2.46%203.38V21h-4V8z'/%3e%3c/svg%3e`,s=`data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2024%2024'%20fill='%2360a5fa'%3e%3cpath%20d='M2%204h20a2%202%200%200%201%202%202v12a2%202%200%200%201-2%202H2a2%202%200%200%201-2-2V6a2%202%200%200%201%202-2zm10%207L2%206.5V18h20V6.5L12%2011z'/%3e%3c/svg%3e`,c=`data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20128%20128'%3e%3cpath%20fill='%23E44D26'%20d='M19%203l8.2%2092.1L64%20125l36.8-29.9L109%203H19z'/%3e%3cpath%20fill='%23F16529'%20d='M64%20117.2l29.7-24.1L100.7%2010H64v107.2z'/%3e%3cpath%20fill='%23EBEBEB'%20d='M64%2046.1H48.6l-1-11.6H64V23.2H35.2l.3%203.1%202.8%2031.1H64V46.1z'/%3e%3cpath%20fill='%23EBEBEB'%20d='M64%2075.4l-.1.1-12.5-3.4-.8-9.4H39.3l1.6%2018.1L64%2087.2V75.4z'/%3e%3cpath%20fill='%23fff'%20d='M63.9%2046.1v11.3h13.8l-1.3%2014.6-12.5%203.4v11.8l23.1-6.4.2-1.9%202.6-29.7.3-3.1H63.9z'/%3e%3cpath%20fill='%23fff'%20d='M63.9%2023.2v11.3h27.3l.2-2.5.5-5.7.3-3.1H63.9z'/%3e%3c/svg%3e`,l=`data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%
:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20128%20128'%3e%3cpath%20fill='%23F34F29'%20d='M124.1%2058.3L69.7%203.9c-5.2-5.2-13.7-5.2-18.9%200L39.5%2015.2l14.3%2014.3c3.3-1.1%207.1-.4%209.8%202.3%202.7%202.7%203.5%206.6%202.2%2010l13.8%2013.8c3.4-1.2%207.3-.5%2010%202.2%203.8%203.8%203.8%2010%200%2013.8-3.8%203.8-10%203.8-13.8%200-2.8-2.8-3.5-6.9-2.1-10.4L60.8%2047.4v34.8c.9.4%201.8%201%202.6%201.8%203.8%203.8%203.8%2010%200%2013.8s-10%203.8-13.8%200-3.8-10%200-13.8c.9-.9%201.9-1.5%203-1.9V47c-1.1-.4-2.1-1-3-1.9-2.9-2.9-3.6-7.1-2-10.8L33.5%2020.2%203.9%2049.8c-5.2%205.2-5.2%2013.7%200%2018.9l54.4%2054.4c5.2%205.2%2013.7%205.2%2018.9%200l46.9-46.9c5.2-5.2%205.2-13.7%200-18.9z'/%3e%3c/svg%3e`,p=`/portfolio/assets/vite-BF8QNONU.svg`,m=`data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2024%2024'%3e%3cpath%20fill='%2360A5FA'%20d='M3%204a2%202%200%200%201%202-2h10a2%202%200%200%201%202%202v7a2%202%200%200%201-2%202H5a2%202%200%200%201-2-2V4zm2%200v7h10V4H5z'/%3e%3cpath%20fill='%23A855F7'%20d='M8%2015h4v2H8z'/%3e%3cpath%20fill='%23A855F7'%20d='M18%207a2%202%200%200%201%202%202v9a2%202%200%200%201-2%202h-3a2%202%200%200%201-2-2V9a2%202%200%200%201%202-2h3zm0%202h-3v9h3V9z'/%3e%3c/svg%3e`,h=`/portfolio/assets/hero-developer-alina-BAN6sj2P.jpg`;document.querySelector(`#app`).innerHTML=`
  ...
  <img src="${h}" alt="Alina Bezsonova Front-End Developer" />
</div>   
    </header>
  ...
  <img src="${c}" alt="HTML5" class="skill-icon">
  <span>HTML5</span>
</div>
 <div class="skill-card">
  <img src="${l}" alt="CSS3" class="skill-icon">
  <span>CSS3</span>
</div>

<div class="skill-card">
  <img src="${u}" alt="SCSS" class="skill-icon">
  <span>SCSS</span>
</div>

<div class="skill-card">
  <img src="${d}" alt="JavaScript" class="skill-icon">
  <span>JavaScript</span>
</div>
<div class="skill-card">
  <img src="${m}" alt="Responsive UI" class="skill-icon">
  <span id="skill-responsive">Responsive UI</span>
</div>

<div class="skill-card">
  <img src="${f}" alt="Git" class="skill-icon">
  <span>Git</span>
</div>

<div class="skill-card">
 <img src="${a}" alt="GitHub" class="skill-icon">
  <span>GitHub</span>
</div>

<div class="skill-card">
  <img src="${p}" alt="Vite" class="skill-icon">
  <span>Vite</span>
</div>
    </section>
   <section class="stats">
...
<section class="certificates" id="certificates">
  ...
  <img src="${r}" alt="Front-End Basic Certificate">
</div>
...
>
  ...
  <img src="${e}" alt="Hlegal" class="project-image">
  ...
  <div class="project-overlay">
    ...
    <p>Responsive Multi-page Website</p>
        ...
        <article class="project-card">
        <div class="project-image-wrapper">
  <img src="${t}" alt="WebStudio" class="project-image">
 ...
 <a
  ...
  >
    GitHub
        ...
        <article class="project-card">
        <div class="project-image-wrapper">
  <img src="${n}" alt="Portfolio" class="project-image">
...
<section class="contacts" id="contact">
  ...
  <img src="${s}" alt="Email" class="contact-icon">
 ...
 <h4 id="contact-email-title">Email</h4>
  ...
  class="contact-card"
>
  <img src="${a}" alt="GitHub" class="contact-icon">
 ...
 <h4 id="contact-github-title">GitHub</h4>
  ...
  class="contact-card"
>
  <img src="${o}" alt="LinkedIn" class="contact-icon">
